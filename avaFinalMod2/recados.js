...
function printTable() {
  ...
  userLogon.myMessages.forEach((i) => {
    list.innerHTML +=
      ...
      `<td><button id="" type="button" class="edit btn btn-success" data-bs-toggle="modal" data-bs-target="#editar" onclick="captureMessage(${num})">
                Editar
              </button> <button id="" type="button" class="erase btn btn-danger" data-bs-toggle="modal" data-bs-target="#excluir" onclick="captureMessage(${num})">
              Excluir
            </button> </td>` +
      "</tr>";
    num++;
